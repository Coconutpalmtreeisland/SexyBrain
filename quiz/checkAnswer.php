...
if ($isCorrect) {
    ...
    $insertOrUpdateSql = "INSERT INTO quizMember (memberId, quizId, isSolved, clearTime) VALUES ('$memberId', '$quizId', 1, '$clearTime') ON DUPLICATE KEY UPDATE isSolved = VALUES(isSolved), clearTime = VALUES(clearTime)";
...
$response = array('correct' => $isCorrect, 'answer' => $quizInfo['answer'], 'hint' => $quizInfo['hint']);
